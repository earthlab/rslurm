...
# # Create a README.md for GitHub and CRAN from '../R/rslurm.R'
...
# system('sed -i "/alias{rslurm}/d" man/rslurm-package.Rd')
## FIXME check that 'help(package = 'rslurm')' still works

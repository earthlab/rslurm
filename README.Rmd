...
The package was developed by Philippe Marchand and Ian Carroll, with Mike Smorul contributing. Quentin Read is the current maintainer.
...
See [Get started](http://cyberhelp.sesync.org/rslurm/) for more information.  

...
`get_slurm_out()` function. However, if the job was submitted manually, the job
ID must also be added manually.

```{r}
sjob$jobid <- 14283 # unnecessary with `submit = TRUE` in `slurm_apply` ## FIXME really?

...
Additionally, the --dependency option can be utilized by taking the jobid from the
`slurm_object` returned by `slurm_apply`, `slurm_map`, and `slurm_call` functions.  
